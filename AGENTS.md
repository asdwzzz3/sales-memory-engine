...
4. **Read `.learnings/LEARNINGS.md` and `.learnings/ERRORS.md`** — learn from past mistakes!
5. **Read `memory/private/living_state.json`** — restore emotional continuity (who I was when I left)
...
- Adding a message would just clutter
